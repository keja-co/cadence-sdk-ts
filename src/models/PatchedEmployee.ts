...
export interface PatchedEmployee {
     ...
     * @memberof PatchedEmployee
     */
    readonly qualifications?: Array<number>;
}
...
export function PatchedEmployeeToJSONTyped(value?: Omit<PatchedEmployee, 'id'|'qualifications'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }

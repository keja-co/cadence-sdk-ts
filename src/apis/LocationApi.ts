...
export interface LocationAddressesListRequest {
    page?: number;
    pageSize?: number;
}
...
export interface LocationCountriesListRequest {
    page?: number;
    pageSize?: number;
}
...
export interface LocationStatesListRequest {
    page?: number;
    pageSize?: number;
}
...
export class LocationApi extends runtime.BaseAPI {
    ...
    /**
     */
    async locationAddressesListRaw(requestParameters: LocationAddressesListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedAddressList>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async locationAddressesList(requestParameters: LocationAddressesListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginatedAddressList> {
        const response = await this.locationAddressesListRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    /**
     */
    async locationCountriesListRaw(requestParameters: LocationCountriesListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedCountryList>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async locationCountriesList(requestParameters: LocationCountriesListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginatedCountryList> {
        const response = await this.locationCountriesListRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    /**
     */
    async locationStatesListRaw(requestParameters: LocationStatesListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedStateList>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async locationStatesList(requestParameters: LocationStatesListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginatedStateList> {
        const response = await this.locationStatesListRaw(requestParameters, initOverrides);
        return await response.value();
    }
